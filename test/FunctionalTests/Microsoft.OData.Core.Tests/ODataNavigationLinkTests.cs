...
namespace Microsoft.OData.Tests
{
    public class ODataNavigationLinkTests
    {
        ...
        public ODataNavigationLinkTests()
        {
            ...
            var entryMetadataContext = ODataResourceMetadataContext.Create(entry, typeContext, serializationInfo, null, metadataContext, SelectedPropertiesNode.EntireSubtree, null);
