...
namespace Microsoft.OData.Tests.Evaluation
{
    public class SelectedPropertiesNodeTests
    {
        ...
        {
            SelectedPropertiesNode.Create("Action(Edm.Int32)").HaveAction(this.cityType, this.action);
        }
        ...
        {
            SelectedPropertiesNode.Create("Action(Edm.Int32)").NotHaveAction(this.openType, this.action);
        }
    ...
    internal static class EvaluationAssertionsExtensions
    {
        ...
        {
            Assert.Equal(SelectedPropertiesNode.EntireSubtree, node);
            return node;
        }
    }
}
