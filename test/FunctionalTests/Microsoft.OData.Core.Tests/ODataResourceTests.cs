...
namespace Microsoft.OData.Tests
{
    public class ODataResourceTests
    {
        ...
        public ODataResourceTests()
        {
            ...
            var entryMetadataContext = ODataResourceMetadataContext.Create(this.odataEntryWithFullBuilder, typeContext, serializationInfo, null, metadataContext, SelectedPropertiesNode.EntireSubtree, null);
