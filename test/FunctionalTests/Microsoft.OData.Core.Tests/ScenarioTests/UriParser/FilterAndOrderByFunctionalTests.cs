...
namespace Microsoft.OData.Tests.ScenarioTests.UriParser
{
    ...
    public class FilterAndOrderByFunctionalTests
    {
        ...
        public void FilterWithInvalidParameterShouldThrow()
        {
            ...
            action.Throws<ODataErrorException>(ODataErrorStrings.MetadataBinder_PropertyNotDeclared("Edm.Int32", "$It"));
        }
        ...
        public void InvalidPropertyNameThrowsUsefulErrorMessage()
        {
            ...
            parseInvalidPropertyName.Throws<ODataErrorException>(ODataErrorStrings.MetadataBinder_PropertyNotDeclared("Fully.Qualified.Namespace.Person", "PersonMetadataId"));
        }
        ...
        public void TrailingDollarSegmentThows()
        {
            ...
            parseWithTrailingDollarSign.Throws<ODataErrorException>(ODataErrorStrings.MetadataBinder_PropertyNotDeclared("Edm.String", "$"));
        }
        ...
        public void ActionsThrowOnClosedTypeInFilter()
        {
            ...
            parseWithAction.Throws<ODataErrorException>(ODataErrorStrings.MetadataBinder_PropertyNotDeclared("Fully.Qualified.Namespace.Person", "Move"));
        }
        ...
        public void ActionBoundToComplexThrows()
        {
            ...
            parse.Throws<ODataErrorException>("Could not find a property named 'ChangeState' on type 'Fully.Qualified.Namespace.Address'.");
        }
        ...
        public void FunctionCallWithGeographyAndNullParameterValuesShouldWorkInFilter()
        {
            ...
            filterClause.Expression.ShouldBeAnyQueryNode()
                .Source.ShouldBeCollectionFunctionCallNode(HardCodedTestModel.GetNearbyPriorAddressesFunction())
        ...
        public void FilterWithInOperationWithBoundFunctions()
        {
            ...
            Assert.Equal("Fully.Qualified.Namespace.GetPriorAddresses", Assert.IsType<CollectionFunctionCallNode>(inNode.Right).Name);
        }
       ...
       [InlineData("(\"abc\",\"xyz\")")]  // for backward compatibility
        ...
        {
            Action parse = () => ParseFilter(filterClause, HardCodedTestModel.TestModel, HardCodedTestModel.GetPersonType());
            ODataException exception = Assert.Throws<ODataException>(parse);
            Assert.Equal(ODataErrorStrings.MetadataBinder_RightOperandNotCollectionValue, exception.Message);
        }
