...
namespace Microsoft.OData.Tests.ScenarioTests.UriParser
{
    ...
    public class SemanticTreeFunctionalTests
    {
        ...
        public void InvalidPropertyShouldFailUnderCastInFilter()
        {
            ...
            Assert.Throws<ODataErrorException>(test);
        }
        ...
        public void RangeVariableNameUsedOutsideOfScopeShouldFailIfTypeIsNotOpen()
        {
            ...
            parse.Throws<ODataErrorException>(ODataErrorStrings.MetadataBinder_PropertyNotDeclared("Fully.Qualified.Namespace.Dog", "a"));
        }
        ...
        public void FilterThroughMissingNavigationOrComplexPropertyShouldThrowOurException()
        {
            ...
            parse.Throws<ODataErrorException>(Strings.MetadataBinder_PropertyNotDeclared("Fully.Qualified.Namespace.Person", "Missing"));
        }
