...
namespace Microsoft.OData.Tests.UriParser
{
    ...
    public class ODataUriParserTests
    {
        ...
        public void ParseAnnotationInFilterForEntityTypeShouldThrow()
        {
            ...
            action.Throws<ODataErrorException>(
        ...
        public void ParseComputeAsQueryOption()
        {
            ...
            Assert.True(items[0].TypeReference.IsEquivalentTo(typeReference));
            Assert.Equal("Property1Lower", items[1].Alias);
            items[1].Expression.ShouldBeSingleValueFunctionCallQueryNode();
            Assert.Equal("Edm.String", items[1].TypeReference.FullName());
            Assert.True(items[1].TypeReference.IsNullable); // tolower is built in function that allows nulls.
        ...
        public void ParseComputeAsExpandQueryOption()
        {
            ...
            Assert.True(computes[0].TypeReference.IsEquivalentTo(typeReference));
        }
        ...
        public void ParseComputeAsLevel2ExpandQueryOption()
        {
            ...
            Assert.True(compute.TypeReference.IsEquivalentTo(typeReference));
            ...
            Assert.True(subCompute.TypeReference.IsEquivalentTo(typeReference));
        }
        #endregion
