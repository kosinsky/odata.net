...
namespace Microsoft.OData.Tests.UriParser.Binders
{
    public class SelectPathSegmentTokenBinderTests
    {
        ...
        public void OperationWithParenthesesShouldNotWork()
        {
            ...
            action.Throws<ODataErrorException>(ODataErrorStrings.MetadataBinder_PropertyNotDeclared("Fully.Qualified.Namespace.Person", "Move()"));
        }
        ...
        public void UnfoundProperyOnClosedTypeThrows()
        {
            ...
            visit.Throws<ODataErrorException>(Strings.MetadataBinder_PropertyNotDeclared(HardCodedTestModel.GetPersonType(), "Missing"));
        }
        ...
        public void UnQualifiedActionNameShouldThrow()
        {
            ...
            visit.Throws<ODataErrorException>(Strings.MetadataBinder_PropertyNotDeclared(HardCodedTestModel.GetDogType(), "Walk"));
        }
