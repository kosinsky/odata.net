...
namespace Microsoft.OData.Tests.UriParser.Binders
{
    ...
    public class SelectBinderTests : SelectExpandBinderTests
    {
        ...
        public void FunctionCallsInSelectTreeThrows()
        {
            ...
            // Arrange
            test.Throws<ODataErrorException>(Strings.MetadataBinder_PropertyNotDeclared(HardCodedTestModel.GetPersonType(), "substring"));
        }
        ...
        public void CustomFunctionsThrow()
        {
            ...
            // Assert
            test.Throws<ODataErrorException>(Strings.MetadataBinder_PropertyNotDeclared(HardCodedTestModel.GetPersonType(), "GetCoolPeople"));
        }
